...
AI_PROMPT_TEMPLATE: str = (
    ...
    "7. Ekstrak informasi gaji dari teks asli ke dalam array 'salaries'. JIKA TIDAK ADA info gaji di teks asli, ANDA WAJIB MEMBUAT ESTIMASI GAJI YANG REALISTIS (berdasarkan standar UMR daerah, posisi, dan industri di Indonesia). Buatkan rentang gaji rata-rata paling logis untuk tiap posisi. JANGAN BIARKAN ARRAY SALARIES KOSONG!\n"
